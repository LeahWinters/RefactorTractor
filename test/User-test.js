...
describe('User', () => {
  ...
  it('calculateAverageMinutesActiveThisWeek should calculate the average minutes active', () => {
  ...
  it('calculateAverageStepsThisWeek should calculate the average steps taken in a given week', () => {
  ...
  it('calculateAverageFlightsThisWeek should calculate the average flights of stairs taken in a given week', () => {
