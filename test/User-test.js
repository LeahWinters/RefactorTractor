...
describe('User', () => {
  ...
  it('should have a default ouncesAverage of 0', () => {
    expect(user.ouncesAverage).to.equal(0);
  });

  it('should have a default ouncesRecord of []', () => {
  ...
  it('should have a default activityRecord of []', () => {
    expect(user.activityRecord).to.deep.equal([]);
  });

  it('should have a default value of [] for accomplishedDays', () => {
    expect(user.accomplishedDays).to.deep.equal([]);
  });

  it('should have a default value of [] for trendingStepDays', () => {
    expect(user.trendingStepDays).to.deep.equal([]);
  });

  it('should have a default value of [] for trendingStairsDays', () => {
  ...
  it('addDailyOunces should show the last week of water', () => {
    user.ouncesRecord = [
      {"2019/06/15": 1},
      {"2019/06/15": 1},
      {"2019/06/16": 4}
  ...
  describe('updateSleep', () => {
    ...
    it('should update user\'s quality of sleep record', () => {
  ...
  it('should calculate average quality of sleep for week before a given date', () => {
    ...
    expect(user.calculateSleepAverages('2019/09/22', user.sleepQualityRecord, 'quality')).to.equal('8.5')
  });

  it('should calculate average hours of sleep for week before a given date', () => {
    ...
    expect(user.calculateSleepAverages('2019/09/22', user.sleepHoursRecord, 'hours')).to.equal('8.5')
  });

  it('should have a method that return the highest climbing record', () => {
    user.activityRecord = [{flightsOfStairs: 10}, {flightsOfStairs: 15}, {flightsOfStairs: 17}]
    expect(user.findClimbingRecord()).to.equal(17)
  });

  it('should calculate the average minutes active', () => {
    ...
    expect(user.calculateAverageWeeklyExercise("2019/09/17", "minutesActive")).to.equal('39')
  });
  ...
  it('should calculate the average steps taken in a given week', () => {
    ...
    expect(user.calculateAverageWeeklyExercise("2019/09/17", "steps")).to.equal('976')
  });

  it('should calculate the average flights of stairs taken in a given week', () => {
    ...
    expect(user.calculateAverageWeeklyExercise("2019/09/17", "flightsOfStairs")).to.equal('8')
  });

  it('updateAccomplishedDays should create an array of good days', () => {
  ...
  it('should find 3+ days with positive steps trend', () => {
    user.activityRecord = [{
  ...
  it('findFriendsTotalStepsForWeek should find friends\' total steps', () => {
    let user2 = new User({
      'id': 16,
      'name': 'Ben Nist',
    })
