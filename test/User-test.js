...
describe('User', function() {
  ...
  it('should calculate average quality of sleep for week before a given date', function() {
    ...
    // let quality = user.sleepQualityRecord.map(item => item.quality);
    // console.log(quality);
    expect(user.calculateSleepAverages('2019/09/22', user.sleepQualityRecord, 'quality')).to.equal('8.5')
    // expect(user.calculateSleepAverages('2019/09/22', user.sleepHoursRecord, 'hours')).to.equal('7.9')
  });
  it('should calculate average hours of sleep for week before a given date', function() {
